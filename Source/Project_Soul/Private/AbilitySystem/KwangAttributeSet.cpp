...
UKwangAttributeSet::UKwangAttributeSet()
{
...
void UKwangAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	if (Data.EvaluatedData.Attribute == GetDamageTakenAttribute())
	{
		...
		const FString DebugString = FString::Printf(
			TEXT("Old Healtfh : %f, Damage Done : %f, NewCurrentHealth : %f"),
			OldHealth,
			DamageDone,
			NewCurrentHealth
		);
